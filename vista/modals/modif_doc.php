...
<div class="modal fade" id="dataUpdateDoc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <div id="datos_ajax"></div>
          <div class="row form-group">
            ...
            empresa <input type="text" class="form-control" id="empresa" name="idempresa">
            <input type="text" class="form-control" id="doc" name="iddoc">
            consorcio <input type="text" class="form-control" id="consorcio" name="idconsorcio">
          </div>
      </div>
      <!--modal FOOTER -->
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-primary" name="updatedoc" id="updatedoc" >Actualizar datos</button>
      </div>
    </div>
  </div>
</div>

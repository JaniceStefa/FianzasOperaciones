...
<div class="modal fade" id="dataUpdateStatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="datos_ajax"></div>
          <div class="row form-group">
            ...
            <label for="" class="form-control-label">Fecha de Ingreso:</label></div>
          ...
          <div class="row form-group">
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">Aseguradora</label>
                </div>
                <div class="col-12 col-md-5">
                   <select name="lstentidad" id="lstentidad" class="form-control" placeholder=" Seleccione entidad" >
                        <option value="">Seleccione una opción</option>
                        <?php
                        foreach ($this->modelo0->Lista_Entidad() as $consulta){           
                        ?>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="updatestatus" id="updatestatus" >Actualizar</button>
      </div>
    </div>
  </div>
</div>

                                ...
                                <div class="row" style="background-color: white; ">
                                    ...
                                    <div class="card-body" ;>
                                       <div class="row">
                                            <?php
                                            $cont = 0;
                                            foreach ($this->modelo3->Consultar_Fechas($cod) as $registro) {?>
                                                <div class="col-md-3">
                                            ...
                                            switch ($registro1['status']) {
                                                case '2':?> 
                                                    ...
                                                    <div class="card border border-secondary">
                                                        ...
                                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#dataEval" title="Evaluacion" data-id="<?php echo $registro1['id_institucion']?>">EVALUACIÓN</button>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <?php break;
